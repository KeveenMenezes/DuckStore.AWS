...
// Duplicated verbatim in Mutation.storeBasket.js and Mutation.deleteBasket.js — AppSync JS
// resolvers are inlined standalone (no bundler/import resolution, see appsync-api.ts's
// `resolver()`), so keep all three copies in sync.
