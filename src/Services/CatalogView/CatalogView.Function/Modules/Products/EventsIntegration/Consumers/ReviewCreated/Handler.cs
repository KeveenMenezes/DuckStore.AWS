...
// (ADR-0030, supersedes ADR-0027's OpenSearch script) — a conditional ADD guarded by
// LastRatingEventId, then a recompute of AverageRating. No separate inbox table is needed: the
