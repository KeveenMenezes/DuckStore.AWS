...
export function request(ctx) {
  ...
  if (input.phone != null) { sets.push('Phone = :phone'); values[':phone'] = input.phone }
  if (input.addressLine != null) { sets.push('AddressLine = :addressLine'); values[':addressLine'] = input.addressLine }
  if (input.city != null) { sets.push('City = :city'); values[':city'] = input.city }
  if (input.state != null) { sets.push('#state = :state'); names['#state'] = 'State'; values[':state'] = input.state }
  if (input.zipCode != null) { sets.push('ZipCode = :zipCode'); values[':zipCode'] = input.zipCode }
  if (input.country != null) { sets.push('Country = :country'); values[':country'] = input.country }
